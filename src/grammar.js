...
var grammar = {
    ...
    {"name": "century", "symbols": ["digit", "digit"], "postprocess": data => ({ values: [num(data)], type: 'century' })},
    ...
    {"name": "L1S", "symbols": ["year", {"literal":"-"}, "d21_24"], "postprocess": data => ({ values: [data[0], data[2]], type: 'season' })},
