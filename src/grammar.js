...
var grammar = {
    ...
    {"name": "L1X", "symbols": ["digit", "digit", "L1X$string$6"], "postprocess": data => ({ values: [num(data.slice(0, 2))], unspecified: X.yyxx })},
    {"name": "L1X", "symbols": ["digit", "digit", "digit", {"literal":"X"}], "postprocess": data => ({ values: [num(data.slice(0, 2))], unspecified: X.yyyx })},
    {"name": "L1X$string$7", "symbols": [{"literal":"X"}, {"literal":"X"}, {"literal":"X"}, {"literal":"X"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "L1X", "symbols": ["L1X$string$7"], "postprocess": data => ({ values: [num(data.slice(0, 2))], unspecified: X.xxxx })},
