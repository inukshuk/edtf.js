...
var grammar = {
    ...
    {"name": "pua_year", "symbols": ["UA", "year"]},
    {"name": "pua_year_month$macrocall$2", "symbols": ["year"]},
    {"name": "pua_year_month$macrocall$1$ebnf$1$subexpression$1", "symbols": ["UA"], "postprocess": id},
    {"name": "pua_year_month$macrocall$1$ebnf$1", "symbols": ["pua_year_month$macrocall$1$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "pua_year_month$macrocall$1$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "pua_year_month$macrocall$1$ebnf$2$subexpression$1", "symbols": ["UA"], "postprocess": id},
    {"name": "pua_year_month$macrocall$1$ebnf$2", "symbols": ["pua_year_month$macrocall$1$ebnf$2$subexpression$1"], "postprocess": id},
    ...
    {"name": "pua_year_month$macrocall$3$ebnf$1$subexpression$1", "symbols": ["UA"], "postprocess": id},
    {"name": "pua_year_month$macrocall$3$ebnf$1", "symbols": ["pua_year_month$macrocall$3$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "pua_year_month$macrocall$3$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "pua_year_month$macrocall$3$ebnf$2$subexpression$1", "symbols": ["UA"], "postprocess": id},
    {"name": "pua_year_month$macrocall$3$ebnf$2", "symbols": ["pua_year_month$macrocall$3$ebnf$2$subexpression$1"], "postprocess": id},
    ...
    {"name": "pua_year_month", "symbols": ["pua_year_month$macrocall$1", {"literal":"-"}, "pua_year_month$macrocall$3"], "postprocess": pick(0, 2)},
    {"name": "pua_year_month_day$macrocall$2", "symbols": ["year"]},
    {"name": "pua_year_month_day$macrocall$1$ebnf$1$subexpression$1", "symbols": ["UA"], "postprocess": id},
    {"name": "pua_year_month_day$macrocall$1$ebnf$1", "symbols": ["pua_year_month_day$macrocall$1$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "pua_year_month_day$macrocall$1$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "pua_year_month_day$macrocall$1$ebnf$2$subexpression$1", "symbols": ["UA"], "postprocess": id},
    {"name": "pua_year_month_day$macrocall$1$ebnf$2", "symbols": ["pua_year_month_day$macrocall$1$ebnf$2$subexpression$1"], "postprocess": id},
    ...
    {"name": "pua_month_day$macrocall$1$ebnf$1$subexpression$1", "symbols": ["UA"], "postprocess": id},
    {"name": "pua_month_day$macrocall$1$ebnf$1", "symbols": ["pua_month_day$macrocall$1$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "pua_month_day$macrocall$1$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "pua_month_day$macrocall$1$ebnf$2$subexpression$1", "symbols": ["UA"], "postprocess": id},
    {"name": "pua_month_day$macrocall$1$ebnf$2", "symbols": ["pua_month_day$macrocall$1$ebnf$2$subexpression$1"], "postprocess": id},
    ...
    {"name": "pua_month_day$macrocall$3$ebnf$1$subexpression$1", "symbols": ["UA"], "postprocess": id},
    {"name": "pua_month_day$macrocall$3$ebnf$1", "symbols": ["pua_month_day$macrocall$3$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "pua_month_day$macrocall$3$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "pua_month_day$macrocall$3$ebnf$2$subexpression$1", "symbols": ["UA"], "postprocess": id},
    {"name": "pua_month_day$macrocall$3$ebnf$2", "symbols": ["pua_month_day$macrocall$3$ebnf$2$subexpression$1"], "postprocess": id},
    ...
    {"name": "pua_month_day", "symbols": ["pua_month_day$macrocall$1", {"literal":"-"}, "pua_month_day$macrocall$3"], "postprocess": pick(0, 2)},
    {"name": "pua_month_day$macrocall$6", "symbols": ["m30"]},
    {"name": "pua_month_day$macrocall$5$ebnf$1$subexpression$1", "symbols": ["UA"], "postprocess": id},
    {"name": "pua_month_day$macrocall$5$ebnf$1", "symbols": ["pua_month_day$macrocall$5$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "pua_month_day$macrocall$5$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "pua_month_day$macrocall$5$ebnf$2$subexpression$1", "symbols": ["UA"], "postprocess": id},
    {"name": "pua_month_day$macrocall$5$ebnf$2", "symbols": ["pua_month_day$macrocall$5$ebnf$2$subexpression$1"], "postprocess": id},
    ...
    {"name": "pua_month_day$macrocall$7$ebnf$1$subexpression$1", "symbols": ["UA"], "postprocess": id},
    {"name": "pua_month_day$macrocall$7$ebnf$1", "symbols": ["pua_month_day$macrocall$7$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "pua_month_day$macrocall$7$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "pua_month_day$macrocall$7$ebnf$2$subexpression$1", "symbols": ["UA"], "postprocess": id},
    {"name": "pua_month_day$macrocall$7$ebnf$2", "symbols": ["pua_month_day$macrocall$7$ebnf$2$subexpression$1"], "postprocess": id},
    ...
    {"name": "pua_month_day", "symbols": ["pua_month_day$macrocall$5", {"literal":"-"}, "pua_month_day$macrocall$7"], "postprocess": pick(0, 2)},
    ...
    {"name": "pua_month_day$macrocall$9$ebnf$1$subexpression$1", "symbols": ["UA"], "postprocess": id},
    {"name": "pua_month_day$macrocall$9$ebnf$1", "symbols": ["pua_month_day$macrocall$9$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "pua_month_day$macrocall$9$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "pua_month_day$macrocall$9$ebnf$2$subexpression$1", "symbols": ["UA"], "postprocess": id},
    {"name": "pua_month_day$macrocall$9$ebnf$2", "symbols": ["pua_month_day$macrocall$9$ebnf$2$subexpression$1"], "postprocess": id},
    ...
    {"name": "pua_month_day$macrocall$11$ebnf$1$subexpression$1", "symbols": ["UA"], "postprocess": id},
    {"name": "pua_month_day$macrocall$11$ebnf$1", "symbols": ["pua_month_day$macrocall$11$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "pua_month_day$macrocall$11$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "pua_month_day$macrocall$11$ebnf$2$subexpression$1", "symbols": ["UA"], "postprocess": id},
    {"name": "pua_month_day$macrocall$11$ebnf$2", "symbols": ["pua_month_day$macrocall$11$ebnf$2$subexpression$1"], "postprocess": id},
    ...
    {"name": "pua_month_day", "symbols": ["pua_month_day$macrocall$9", {"literal":"-"}, "pua_month_day$macrocall$11"], "postprocess": pick(0, 2)},
