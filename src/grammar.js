...
var grammar = {
    ...
    {"name": "L1", "symbols": ["unspecified"]},
    {"name": "unspecified$string$1", "symbols": [{"literal":"-"}, {"literal":"X"}, {"literal":"X"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "unspecified", "symbols": ["year_month", "unspecified$string$1"]},
    {"name": "unspecified$string$2", "symbols": [{"literal":"-"}, {"literal":"X"}, {"literal":"X"}, {"literal":"-"}, {"literal":"X"}, {"literal":"X"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "unspecified", "symbols": ["year", "unspecified$string$2"]},
    {"name": "unspecified$string$3", "symbols": [{"literal":"X"}, {"literal":"X"}, {"literal":"X"}, {"literal":"X"}, {"literal":"-"}, {"literal":"X"}, {"literal":"X"}, {"literal":"-"}, {"literal":"X"}, {"literal":"X"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "unspecified", "symbols": ["unspecified$string$3"]},
    {"name": "unspecified$string$4", "symbols": [{"literal":"-"}, {"literal":"X"}, {"literal":"X"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "unspecified", "symbols": ["year", "unspecified$string$4"]},
    {"name": "unspecified$string$5", "symbols": [{"literal":"X"}, {"literal":"X"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "unspecified", "symbols": ["digit", "digit", "unspecified$string$5"]},
    {"name": "unspecified", "symbols": ["digit", "digit", "digit", {"literal":"X"}]},
    {"name": "unspecified$string$6", "symbols": [{"literal":"X"}, {"literal":"X"}, {"literal":"X"}, {"literal":"X"}, {"literal":"-"}, {"literal":"X"}, {"literal":"X"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "unspecified", "symbols": ["unspecified$string$6"]},
